...
import { createJwtAuthMiddleware } from "@lib/middleware/jwt-auth.middleware.js";
import { LoginRoute } from "@lib/route/login.route.js";
import { CreateRoute } from "@lib/route/create.route.js";
import { ProfileRoute } from "@lib/route/profile.route.js";
import { ListRoute } from "@lib/route/list.route.js";
import { GetRoute } from "@lib/route/get.route.js";
...
export class Module implements ModuleInterface {
    ...
    public async setupRoutes(fastify: FastifyInstanceTypeForModule) {
        ...
        const jwtAuthMiddleware = createJwtAuthMiddleware(this.context.em,this.context.configuration.jwtSecret);
